...
/**
 * A utility class to convert between sets of artifacts with different type parameters, where the actuals contents of
 * the sets are compatible, but the Java type inferences cannot recognize this.
 */
