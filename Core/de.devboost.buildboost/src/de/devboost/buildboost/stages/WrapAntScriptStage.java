...
/**
 * The {@link WrapAntScriptStage} can be used to integrate existing Ant scripts into a build process. The stage produces
 * a Ant target that calls the given Ant script.
 */
public class WrapAntScriptStage extends AbstractBuildStage {
	 ...
	 * 
	 * @param directory
	 *            the working directory for the Ant script
	 * @param antFile
	 *            the script to call (using absolute files is recommended here, because this parameter is independent of
	...
	public AntScript getScript() throws BuildException {
		...
		content.append("<ant antfile=\"" + antFile.getAbsolutePath() + "\"" + targetAttribute + " dir=\""
